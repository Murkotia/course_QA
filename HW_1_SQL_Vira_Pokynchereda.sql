...
select name from students where id < '27' or id > '88';

 --22. Вывести пользователя у которых id меньше либо равно 37
select name from students where id < '27' or id = '27';

 --23. Вывести пользователя у которых id больше либо равно 37
select name from students where id > '37' or id = '37';

 --24. Вывести пользователя у которых id больше 80 но меньше 90
select name from students where id > '80' and id < '90';

 --25. Вывести пользователя у которых id между 80 и 90
select name from students where id between '80' and '90';
...
select name from students where created_on = '2020-10-03 00:00:00' 
